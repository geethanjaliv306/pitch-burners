...
public function getBattingStats(Request $request)
{
    ...
    if (($tournamentId !== 'null')) {
        ...
        ->leftjoin('players', 'match_stats.player_id', '=', 'players.id') //to get players detils
        ->leftjoin('teams', 'match_stats.team_id', '=', 'teams.id')   //to get team details
        ->leftjoin('matches', 'match_stats.match_id', '=', 'matches.id') //to get match details
