...
class StandingsController extends Controller
{
     ...
     public function index(Request $request)
    {
        ...
        $tournamentId = $request->input('tournament_id');
       	...
       	//NOTE: for updating, need to remove the below one line.
   ...
   //private function getGroups(int $tournamentId)
    ...
    private function getGroups(int $tournamentId){
        ...
        $groupRoundMap = [];
        foreach ($tournamentGroups as $tg) {
            $groupRoundMap[$tg->group_id] = $tg->round_id;
        }
        $groups->transform(function ($group) use ($groupRoundMap) {
            $group->round_id = $groupRoundMap[$group->id] ?? null;
            return $group;
        });
