        ...
        <div class="row h-100">
            <div class="col-12">
                <div class="title-wrap h-100">
                    <h2>
                            <a class="my-torunments-back" href="{{ route('tournaments-teams', $tournamentId) }}"> </a>Team Players
                    </h2>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                @foreach($players as $index => $player)
                    <tr class="{{ $player->is_captain ? 'captain-row' : '' }}">
...
<script>
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            editForm.action = `/players/${playerId}`;
