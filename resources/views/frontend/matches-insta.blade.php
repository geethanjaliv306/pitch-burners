...
.win-trophy {
 ...
 .knockouts-results-box{
  padding-bottom: 0;
  position: relative;
  border-radius: 0;
 }
 .sponser-bottom-logo img{
  width: auto;
 }
 .sponser-bottom-logo img.logo-kirti{ height: 25px;}
 .sponser-bottom-logo img.logo-craft{ height: 75px;}
 .sponser-bottom-logo img.logo-support{ height: 20px;}
 .sponser-bottom-logo img.logo-man{ height: 45px;}
 .sponser-bottom-logo img.logo-royal{ height: 30px;}
 .sponser-bottom-logo img.logo-aprc{ height: 60px;}
 .sponser-bottom-logo img.logo-d{ height: 22px; }
 .sponser-bottom-logo img.logo-gx{ height: 35px; }
 .sponser-bottom-logo img.logo-nivi{ height: 30px; }
.social-design{
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.social-design .sociallogoTop{
  position: absolute;
}
.social-design .sociallogoTop.leftz{
  left: 0;
  top: 50px;
  width: 110px;
  height: auto;
}
.social-design .sociallogoTop.rightz{
  right: 12px;
  top: 60px;
  width: 75px;
  height: auto;
...
.knockouts-results-box .stages-name{
  border-radius: 10px;
  padding: 5px 20px;
}
.knockouts-results-box .dates-location{
  margin-bottom:8px;
}
.sponser-bottom-logo{
margin-top:-14px;
}
.knockouts-results-box .teamname-wrap{
  margin-bottom:10px;
}
.knockouts-results-box .teamname-wrap .teamvs
{
  min-height:55px;
}
.knockouts-results-box .teamname-wrap .teamname{
  font-size:18px;
}
  .knockouts-results-box .captain-figure{
    margin-bottom:25px;
}
.knockouts-results-box .stages-name .stage{
  font-size:16px;
  line-height:20px;
}
.knockouts-results-box .stages-name{
...
.sponser-bottom-logo img.logo-aprc{
  position:relative;
  top:-7px;
}
 
 
.knockouts-results-box .score-wrap .scoreInfo strong{ font-size: 19px; }
.knockouts-results-box .score-wrap .scoreInfo span{ font-size: 16px; }
.knockouts-results-box .result-info{ margin: 0 0 0px; font-size: 15px; }
  ...
  margin-top: 10px;
   ...
   .knockouts-results-box .captain-figure > div{
...
<section class="addnewplayer-title-wrap fixed-second-header teams-second-header">
    ...
    <!-- Tournament Dropdown -->
    <div class="dropdown seasondropdown drp d-none">
        <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
...
@endif {{ $match['teamB_score'] }}</p><span>({{ $match['teamBovers'] }})</span></div>
                 ...
                 <div class="knockouts-results-box" onclick="window.location='{{ route('matches.details', $match['id']) }}';" style="cursor: pointer;">
                    <div class="social-design">
                  <img class="sociallogoTop leftz" src="/uploads/images/1738340322_679cf7e242268.png">
                  <img class="sociallogoTop rightz  d-none " src="https://staging.geohomefinder.com/uploads/partners/1738340335_679cf7ef899ce.png">
                  <img class="sociallogoTop rightz" src="/uploads/images/1738340335_679cf7ef899ce.png">
                  <img class="long" width="250" src="https://staging.geohomefinder.com/uploads/images/pitchburners-new-logo1.png">
                  <h3>PBCCL Season 7</h3>
                  <img class="short" src="https://staging.geohomefinder.com/uploads/images/logo.png" />
                </div>
                    <div class="stages-name">
                       <p class="stage">@if($match['round_id'] == 6) ROUND ROBIN, @else KNOCKOUT, @endif {{ $match['round_name'] }}</p>
         ...
         alt="" />
                ...
                <div class="score-wrap">
                 ...
                 <p class="result-info d-flex justify-content-center">
                  ...
                  <div class="sponser-bottom-logo">
                  <img class="logo-kirti" src="https://staging.geohomefinder.com/uploads/partners/1738340271_679cf7afa35fa.png" />
                  <img class="logo-craft" src="https://staging.geohomefinder.com/uploads/partners/logo-craft-interactive.png" />
                  <img class="logo-man" src="https://staging.geohomefinder.com/uploads/partners/1738340346_679cf7fa53174.png" />
                  <img class="logo-royal" src="https://staging.geohomefinder.com/uploads/partners/logo-royal-gadgets.png" />
                  <img class="logo-d" src="https://staging.geohomefinder.com/uploads/partners/1738340785_679cf9b146f82.png" />
                  <img class="logo-gx" src="https://staging.geohomefinder.com/uploads/partners/logo-gx-fashion.png" />
                  <img class="logo-aprc" src="https://staging.geohomefinder.com/uploads/partners/1739051917_67a7d38de3be3.jpg" />
                  <img class="logo-nivi" src="https://staging.geohomefinder.com/uploads/partners/NIVI.jpeg" />
                </div>
              </div>
