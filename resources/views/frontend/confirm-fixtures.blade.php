...
<section class="addnewplayer-title-wrap fixed-second-header teams-second-header">
    ...
    <div class="dropdown seasondropdown drp">
        <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <p>{{ $selectedTournamentId ? $tournaments->firstWhere('id', $selectedTournamentId)->name : 'Select Tournament' }}</p>
        </button>
        <ul class="dropdown-menu dropdown-menu-end">
    ...
    @if($selectedTournamentId || $selectedTeamId || $selectedVenueId || $selectedStatus)
    <div class="reset">
                    ...
                    @else
                        @foreach($filteredMatches as $match)
                           ...
                           {{--     <div class="date-info">
                              ...
                              <div class="date-info">
                    <div class="date-time">
                      <p class="datetime"><img style="margin-right: 5px;" width="22" height="22" src="/uploads/images/schedule.svg" />{{ \Carbon\Carbon::parse($match['match_date_time'])->format('M') }}, {{ \Carbon\Carbon::parse($match['match_date_time'])->format('D d') }}<span>|</span> {{ \Carbon\Carbon::parse($match['match_date_time'])->format('g:i A') }}</p>
                    </div>
                    <div class="location">
                                        ...
                                        <div class="teamA d-flex align-items-center">
                                            ...
                                            <div>
                                               <h5 style="display: flex; align-items:center;">
                                                ...
                                                @else
                                                <div class="score loss"><p class="team1-score">  {{ $match['teamA_score'] }}</p><span>({{ $match['teamAovers'] }})</span></div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="teamB d-flex align-items-center">
                                            ...
                                            <div>
                                              <h5 style="display: flex;align-items:center;">
                                               ...
                                               @else
                                                <div class="score loss"><p class="team2-score">  {{ $match['teamB_score'] }}</p><span>({{ $match['teamBovers'] }})</span></div>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
